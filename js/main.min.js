!(function (e) {
  ...
  function (e, t, n) {
    ...
    r.mobileNavToggle.addEventListener("click", function () {
      this.classList.toggle("menu-toggle-active"),
        r.mobileNav.classList.toggle("menu-visible"),
        this.getAttribute("aria-expanded") === "false"
          ? this.setAttribute("aria-expanded", "true")
          : this.setAttribute("aria-expanded", "false");
    }),
      (function () {
        const e = r.wrapper.querySelectorAll("[data-lazy]");
        if (e.length > 0) {
